...
urlpatterns = patterns('',
    ...
    url(r'^gallery.html$', WebUi.views.Galeria),
    url(r'^$','django.views.generic.simple.direct_to_template',{'template':'/home/puercopop/webapps/django/myproject/Templates/main_page.html'}),
